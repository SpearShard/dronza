    ...
    <section className="bg-black text-white py-24 px-6  md:px-12 lg:px-24 flex flex-col md:flex-row gap-[5vw] justify-center">
      ...
      <div className="relative flex items-center justify-center w-[30vw] h-[30vw] ">
        ...
        >
          ...
          <span className="absolute w-4 h-4 bg-red-600 rounded-full top-[-10px] left-1/2 -translate-x-1/2 shadow-[0_0_10px_2px_rgba(255,0,0,0.6)]"></span>
          <span className="absolute w-4 h-4 bg-red-600 rounded-full bottom-[-10px] left-1/2 -translate-x-1/2 shadow-[0_0_10px_2px_rgba(255,0,0,0.6)]"></span>
          <span className="absolute w-4 h-4 bg-red-600 rounded-full top-1/2 left-[-10px] -translate-y-1/2 shadow-[0_0_10px_2px_rgba(255,0,0,0.6)]"></span>
          <span className="absolute w-4 h-4 bg-red-600 rounded-full top-1/2 right-[-10px] -translate-y-1/2 shadow-[0_0_10px_2px_rgba(255,0,0,0.6)]"></span>
        </div>

        {/* Image or video inside circle */}
        <div className=" relative w-[30vw] h-[30vw]  rounded-full overflow-hidden z-10">
          <img
            src="https://gridvalley.net/wp/dronza/wp-content/uploads/2020/12/bg-9.jpg"
            alt="city"
      ...
      <div className=" max-w-lg text-left flex flex-col justify-center">
        ...
        <button className="mt-8 bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 transition-colors">
          Read More
        </button>
      </div>
    </section>
